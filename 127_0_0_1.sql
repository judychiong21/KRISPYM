...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 09, 2025 at 12:10 PM
...
-- Database: `chiong`
--
CREATE DATABASE IF NOT EXISTS `chiong` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `chiong`;
...
(1, 'judychiong@gmail.com', 'password');
--
-- Database: `cugondb`
--
CREATE DATABASE IF NOT EXISTS `cugondb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `cugondb`;
...
-- Database: `dbms`
--
CREATE DATABASE IF NOT EXISTS `dbms` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `dbms`;
--
-- Database: `db_scan`
--
CREATE DATABASE IF NOT EXISTS `db_scan` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `db_scan`;
...
-- Database: `delivery`
--
CREATE DATABASE IF NOT EXISTS `delivery` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `delivery`;
...
INSERT INTO `menu_items` (`id`, `name`, `image_path`, `price`) VALUES
(7, 'Buffalo', '../user/Items_IMG/buffalo.jpg', 360.00),
(6, 'Honey Mustard', '../user/Items_IMG/honey.jpg', 380.00),
(5, 'Lemon Pepper', '../user/Items_IMG/lemon.jpg', 370.00),
(8, 'Garlic Parmesan', '../user/Items_IMG/garlic.jpg', 350.00);
...
-- Database: `kani`
--
CREATE DATABASE IF NOT EXISTS `kani` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `kani`;
...
-- Database: `krispym`
--
CREATE DATABASE IF NOT EXISTS `krispym` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `krispym`;
...
(1, 'judy', 'judy', '$2y$10$K8rMS0JS5A2RZGVkBMb7s.mwPHUvkej1fofMkaQSfutZe1EroNAMy');
--
-- Database: `login_admin`
--
CREATE DATABASE IF NOT EXISTS `login_admin` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `login_admin`;
